...
public class YewTreeFeatureConfig extends BaseTreeFeatureConfig implements IFeatureConfig {
	 ...
	 public final BlockStateProvider trunkProvider;
	   ...
	   protected YewTreeFeatureConfig(BlockStateProvider trunkProviderIn, BlockStateProvider leavesProviderIn, List<TreeDecorator> decoratorsIn, int baseHeightIn) {
	   ...
	   protected YewTreeFeatureConfig setSapling(net.minecraftforge.common.IPlantable value) {
	      this.sapling = value;
	      return this;
	   }
	   ...
	   public static <T> YewTreeFeatureConfig deserialize(Dynamic<T> data) {
	      ...
	      return new YewTreeFeatureConfig(blockstateprovidertype.func_227399_a_(data.get("trunk_provider").orElseEmptyMap()), blockstateprovidertype1.func_227399_a_(data.get("leaves_provider").orElseEmptyMap()), data.get("decorators").asList((p_227374_0_) -> {
	   ...
	   public static <T> YewTreeFeatureConfig deserializeJungle(Dynamic<T> data) {
	   ...
	   public static class Builder {
	      ...
	      public YewTreeFeatureConfig.Builder baseHeight(int baseHeightIn) {
	         this.baseHeight = baseHeightIn;
	         return this;
	      }

	      public YewTreeFeatureConfig.Builder setSapling(net.minecraftforge.common.IPlantable value) {
	         this.sapling = value;
	         return this;
	      }

	      public YewTreeFeatureConfig build() {
	         return new YewTreeFeatureConfig(this.trunkProvider, this.leavesProvider, this.decorators, this.baseHeight).setSapling(sapling);
	      }
	   }
}