...
import com.misterspalding.spaldingsadditions.slots.FrakhammerSlot;
...
public class AutoFrakContainer extends CommonContainer {

	private static int numSlots = 4;

	public AutoFrakContainer(int id, PlayerInventory playerInventory) {
		this(id, playerInventory, new AutoFrakTileEntity(), new IntArray(8), numSlots);
	}

	public AutoFrakContainer(int id, PlayerInventory playerInventory, TileEntityMachineCommon tileEntity, IIntArray fields,
			int size) {
		super(ContainersDec.AUTOFRAK, id, playerInventory, tileEntity, fields, numSlots);
		// input
		this.addSlot(new FrakhammerSlot(tileEntity, 1, 9, 44));
		// fuel
