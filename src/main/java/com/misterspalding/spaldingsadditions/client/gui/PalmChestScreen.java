...
@OnlyIn(Dist.CLIENT)
public class PalmChestScreen extends ContainerScreen<PalmChestContainer> {

	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(SpaldingsAdditions.MOD_ID,
			"textures/gui/small_chest.png");

	public PalmChestScreen(PalmChestContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
