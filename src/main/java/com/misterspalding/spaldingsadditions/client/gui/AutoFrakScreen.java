...
@OnlyIn(Dist.CLIENT)
public class AutoFrakScreen extends MachineScreenCommon<AutoFrakContainer> {

    public static final ResourceLocation TEXTURES = new ResourceLocation("spaldingsadditions:textures/gui/autofrak.png");
    

    public AutoFrakScreen(AutoFrakContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
